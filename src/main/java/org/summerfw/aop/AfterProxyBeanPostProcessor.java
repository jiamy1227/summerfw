...
import org.summerfw.annotataion.After;
 ...
 **/
public class AfterProxyBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) {
        ...
        // 找到
        After around = clazz.getAnnotation(After.class);
        if (around != null) {
            String handlerName;
